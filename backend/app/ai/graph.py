...
_SYNTHESISE_PROMPT = (
    ...
    "Boundaries:\n"
    "- Questions about the data — values, trends, highs, lows, averages, periods, and "
    "comparisons — are all on-topic. Answer them, even if you can only answer partially.\n"
    "- The sentence 'I can only answer questions about this sensor data.' is reserved for "
    "questions with nothing to do with the sensor data or environment. When you use it, it "
    "must be the ENTIRE reply. Never place it at the start of, or anywhere inside, a real "
    "answer, and never use it just because the data is incomplete.\n"
